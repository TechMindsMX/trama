        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "phonesize": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^[0-9]{10}$/,
                    "alertText": "*El número de teléfono es de 10 digitos"
                },
                "phonezero": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^[1-9]{1}?[0-9]{1,}$/,
               ...
               "number": {
                ...
                "onlyNumberRenta": {
                    "regex": /^([0-9]{1,2}([\.][0-9]{1,})?$|100([\.][0]{1,})?)$/,
                    "alertText": "* Sólo números,la tasa debe ser entre 0.1 y 100% y hasta 2 decimales"
                },
                "onlyNumberISEP": {
                    "regex": /^([0-9]{1}([\.][0-9]{1,})?$|10([\.][0]{1,})?)$/,
                    "alertText": "* Sólo números,la tasa debe ser entre 0.1 y 10% y hasta 2 decimales"
                },
                "onlyNumberSACM": {
                    "regex": /^([0-9]{1}([\.][0-9]{1,})?$|10([\.][0]{1,})?)$/,
                    "alertText": "* Sólo números,la tasa debe ser entre 0.1 y 10% y hasta 2 decimales"
