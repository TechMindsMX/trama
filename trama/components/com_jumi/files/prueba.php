...
$pathJumi = '/hexeris/components/com_jumi/files';
...
$document->addScript($pathJumi.'/minified/jquery.tree.min.js');
$document->addStyleSheet($pathJumi.'/minified/jquery.tree.min.css');
?>
